...
# Define file paths
data_file_path = '/storage/emulated/0/data_EEG/during/combined_data_during.edf'

pdf_filename = '/storage/emulated/0/data_EEG/during/results_combined_during_final2.pdf'
jpg_dir = '/storage/emulated/0/data_EEG/during/jpg_images/'
...
print("Figures and results saved successfully.")
